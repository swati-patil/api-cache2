...
public class JsonToMap {
	...
	public static Map<String, Integer> generateReposByForkMap(String jsontxt) {
		return generateMapFromResponse(Constants2.MAPKEY, Constants2.FORKCOUNTMAPVALUE, jsontxt);
	}
	
	public static Map<String, Integer> generateReposByWatchersMap(String jsontxt) {
		return generateMapFromResponse(Constants2.MAPKEY, Constants2.WATCHERSMAPVALUE, jsontxt);
	}
	
	public static Map<String, Integer> generateReposByOpenIssuesMap(String jsontxt) {
		return generateMapFromResponse(Constants2.MAPKEY, Constants2.OPENISSUEVALUE, jsontxt);
	}
	...
	public static Map<String, Integer> generateReposByStarsMap(String jsontxt) {
		return generateMapFromResponse(Constants2.MAPKEY, Constants2.STARSMAPVALUE, jsontxt);
	}
	
	public static Map<String, String> generateReposByLastUpdatedMap(String jsontxt) 
			throws Exception {
		return generateUpdatedMapFromJSON(Constants2.MAPKEY, Constants2.LASTUPVALUE, jsontxt);
	}
